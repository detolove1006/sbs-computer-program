...
#pragma region 주소 연산자
	...
	// 데이터의 주소는 해당 데이터가 저장된 메모리의 주소를
	// 의미하며, 메모리 공간은 3 byte의 크기로 나누어 표현합니다.
#pragma endregion
...
#pragma region scanf_s 함수
	...
	//printf("입력하세요\n");
	//
	//	//표준입력 함수는 입력을 수행할 때까지 다음 작업으로 넘어갈 수 없습니다.(다시 입력하세요)
	//
	//	//버퍼는 데이터가 이동할 때 임시로 저장되는 공간이며.
	//	// 서식 지정자에 따라 입력할 수 있는 데이터의 변환도 
	//
	//scanf_s("%d", &a1);
	//printf("a1 변수의 값 : %d\n", a1);

	//표준 입력 함수로 데이터를 입력하게 되면 버퍼
	//데이터를 보관하였다가 입력되는 조건 버퍼만의
	//내용을 프로그램에 전송됩니다.
#pragma endregion
